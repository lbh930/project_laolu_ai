...
#include "ZenBlink.h"
#include "ZenBlinkComponent.generated.h"

/**
 * ZenBlink Actor Component parent
 */
UCLASS(Blueprintable, BlueprintType)
class ZENBLINK_API UZenBlinkComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, Category = "Metahuman", meta = (ExposeOnSpawn = "true"))
